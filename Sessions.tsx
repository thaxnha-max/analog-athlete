 ...
 * Sessions Page
 * 
 * Displays and manages workout sessions with persistent storage.
 * Allows users to log new workouts and view history.
 */
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="container relative py-6 sm:py-8 lg:py-10">
        ...
        <div className="mb-8 grid gap-4 sm:grid-cols-3">
          ...
          <Card className="analog-panel border-2 border-[#111111] bg-[#fbf7ed] shadow-[6px_6px_0_#111111]">
            <CardContent className="p-4">
              ...
              <p className="mt-2 font-display text-3xl uppercase text-[#111111]">
                {Math.round(
                  (data?.workouts.reduce((sum, w) => sum + w.duration, 0) || 0) / 60
                )}
        ...
        <div>
          ...
          <WorkoutHistory date={selectedDate} />
        </div>
      </main>
    </div>
  );
